...
void main()
{
  if (cpuid() == 0)
  {
    ...
    log_message(LOG_INFO, "Welcome to AUT MCS Principles of Operating Systems Course. This message is from a custom logger implemented by 40113431 and 40111002");
